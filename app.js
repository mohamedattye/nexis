...
document.getElementById("export-pdf").addEventListener("click", () => {
  ...
  doc.setFontSize(12);
  doc.text(`Chiffre d'affaires : ${money(revenue)} FCFA`, 20, 75);
  doc.text(`Dépenses de course : ${money(tripExpenses)} FCFA`, 20, 85);
  doc.text(`Charges fixes : ${money(fixedCosts)} FCFA`, 20, 95);
  doc.text(`Résultat net réel : ${money(realNet)} FCFA`, 20, 105);
